...
{tags:['elig'],keywords:['BT eligible vs not BT eligible difference what changes VTS contract SMT 1725 1720J 70.72'],
q:'What is the difference between BT eligible and not BT eligible — and why does it matter?',
a:'This is one of the most important distinctions in the entire VTP program. <b>BT eligibility determines which transport authorities and payment methods are available.</b><br><br><b>A Veteran IS BT eligible if they meet ONE of these:</b><br>• Traveling for treatment of a service-connected (SC) disability (any % rating)<br>• SC rating of 30% or more (traveling for any condition)<br>• Traveling for a scheduled C&P examination<br>• Receiving VA pension under 38 U.S.C. §1521<br>• Annual income does not exceed the maximum pension rate under 38 U.S.C. §1521<br>• Traveling to obtain a service dog (38 CFR §17.148)<br>• Veterans with SCI/D, vision impairment, or multiple amputations traveling to VA special rehab programs (P.L. 114-223)<br><br><b>IF BT ELIGIBLE:</b><br>✅ Can receive mileage/common carrier reimbursement<br>✅ Can use contract SMT (ambulance/wheelchair van) if clinician determines medically required<br>✅ Emergency SC care at non-VA = 38 U.S.C. 1728 applies (reimburses travel AND medical)<br>✅ Emergency processed as 1703 (if reported within 72 hrs) or 1728<br>✅ VISN 20 pre-pay may apply if income below pension threshold<br>✅ Discharge from VA-authorized non-VA facility to home = BT covers transport<br><br><b>IF NOT BT ELIGIBLE:</b><br>❌ Cannot receive BT mileage or common carrier reimbursement<br>❌ Cannot use contract SMT through BT program<br>✅ CAN still use VTS direct transport (enrolled Veterans for any scheduled/urgent/unscheduled visit)<br>✅ CAN receive emergency reimbursement under 38 U.S.C. 1725 (non-SC, no other insurance) — medical costs only, no travel reimbursement<br>✅ 1720J emergent suicide care — NO BT eligibility required<br><br><b>FOR NON-VA TO NON-VA TRANSPORT (both VA-authorized):</b><br>BT eligibility does NOT change the core answer for this scenario:<br>• VTS transport under 38 CFR 70.72(c) = authorized if BOTH facilities are VA-authorized (regardless of BT eligibility)<br>• Contract SMT through BT = NOT authorized for non-VA to non-VA transport leg (regardless of BT eligibility)<br>• BT mileage = NOT clearly authorized for non-VA to non-VA transport leg<br>• Sending VA facility is responsible under VHA Directive 1094 regardless of BT eligibility<br><br><span class="auth">38 CFR 70.10(a)</span> <span class="auth">38 CFR 70.72(c)</span> <span class="auth">38 U.S.C. §1725</span> <span class="auth">38 U.S.C. §1720J</span> <span class="auth">VHA Directive 1094(1)</span><div class="crit">For emergency 911/ER scenarios: OCC through eCAMS determines whether 1703 (BT eligible required), 1725 (NOT BT eligible — medical reimbursement only, no travel), or 1728 (BT eligible, SC condition — medical AND travel reimbursement) applies.</div>'},
...
// ══ CNH ═══════════════════════════════════════════════════════════════════════
{tags:['proc'],keywords:['community nursing home CNH VA authorized transport periodic appointments discharge place of stay 70.72'],
q:'What are the BT and VTS rules for Veterans in VA-authorized Community Nursing Homes (CNH)?',
a:'A VA-authorized CNH under 38 U.S.C. §1720 is the Veteran\'s <b>place of stay</b> for all BT calculations.<br><br><b>CNH → VA for periodic appointments:</b><br>• BT eligible: Standard BT — mileage + contract SMT if medically required. CNH is origin. Payment cap from CNH, not prior residence.<br>• NOT BT eligible: VTS direct transport only — no mileage, no contract SMT.<br><br><b>CNH → VA-authorized community specialist:</b><br>• BT eligible: Standard BT — two VA authorizations needed: CNH placement (1720) + community care for specialist (1703).<br>• NOT BT eligible: VTS direct transport only.<br><br><b>CNH → non-VA ER (911 call):</b><br>• 1725 reimburses the emergency ambulance provider for medical costs — NOT a pre-arranged contract transport.<br>• If Veteran is BT eligible and condition is SC: 1728 may apply (covers medical AND travel).<br>• VA SMT contract does NOT apply to 911 calls.<br><br><b>Non-medical transport from CNH (family visits, social passes):</b><br>• NOT covered under BT or VTS regardless of BT eligibility. Hard exclusion.<br><br><b>Discharge from CNH to home:</b><br>• BT eligible: Standard BT — CNH is place of stay, home is destination. Contract SMT if medically required.<br>• NOT BT eligible: VTS direct transport only.<br><br><b>AMA discharge from CNH:</b><br>• Hard stop regardless of BT eligibility. No BT, no VTS, no contract SMT.<br><br><b>CNH → another non-VA facility (both VA-authorized):</b><br>• VTS transport authorized under <b>38 CFR 70.72(c)</b> — VTS may transport between VA or VA-authorized health care facilities.<br>• Contract SMT through BT NOT authorized for this non-VA to non-VA leg.<br>• Sending VA facility responsible under VHA Directive 1094.<br><br><span class="auth">38 U.S.C. §1720</span> <span class="auth">38 CFR 70.30(b)(3)(5)</span> <span class="auth">38 CFR 70.72(c)</span> <span class="auth">VHA Directive 1094(1)</span>'},
